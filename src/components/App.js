      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={()=> handleMemoryAdd("M+")}/>
              <CalcButton value={"MR"} onClick={()=> handleMemoryApply("MR")}/>
              <CalcButton value={"MC"} onClick={()=> handleMemoryClear("MC")}/>
            </div>
            ...
            <div className="row ce_button">
              <CalcButton value={"CE"} onClick={()=>handleClearDisplay("CE")}/>
            </div>
